...
- extraContextRelevance: 'relevant' | 'irrelevant' | 'duplicate' | null. Set to one of the three strings only on post-coverage Discovery turns when phase-specific rules instruct you to. Use null on bootstrap and core-coverage turns.
- followUpQuestion: boolean | null. Set to true only on Discovery turns classified 'relevant' where your assistantMessage contains a single targeted follow-up question. Set to false on Discovery turns classified 'irrelevant' or 'duplicate'. Use null otherwise.
