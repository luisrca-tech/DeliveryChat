...
| 5     | Cross-cutting documentation               | ✅ Completed | TBD       | Comprehensive feature doc in `test-applications.md` (this folder). Public doc at `packages/docs/applications/test-applications.md` linked from the docs README. Deferred Stripe-style global test-mode alternative captured in `packages/docs/todo/global-test-mode-toggle.md`.                                                                                  |
