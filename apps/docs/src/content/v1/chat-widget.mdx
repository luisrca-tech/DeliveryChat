...
## Advanced: JavaScript SDK

For programmatic control, event listeners, visitor identity, headless mode (custom UI), or npm-based integration, see the [JavaScript SDK documentation](/v1/sdk).
  ...
  links={[
    {
      ...
      href: "/v1/sdk",
      description: "Programmatic control, events, identity, and headless mode"
    },
    {
      title: "Applications",
