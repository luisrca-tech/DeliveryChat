...
type Props = {
  /** When true, plain Enter creates a new list item instead of sending. */
  interceptPlainEnter?: boolean;
};

/**
 * List-aware Enter handling for the chat composer.
 * - Plain Enter in a list: new bullet / numbered item (when interceptPlainEnter).
 * - Ctrl/Alt+Enter in a list: new bullet / numbered item.
 * - Ctrl/Alt+Enter outside a list: soft line break.
 */
